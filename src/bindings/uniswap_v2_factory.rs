pub use uniswap_v2_factory_contract::*;
...
pub mod uniswap_v2_factory_contract {
    #[rustfmt::skip]
    ...
    impl<M> ::core::ops::Deref for uniswap_v2_factory<M> {
        type Target = ::ethers::contract::Contract<M>;
        fn deref(&self) -> &Self::Target {
            &self.0
        }
    }
    impl<M> ::core::ops::DerefMut for uniswap_v2_factory<M> {
        fn deref_mut(&mut self) -> &mut Self::Target {
            &mut self.0
        }
    }
    impl<M> ::core::fmt::Debug for uniswap_v2_factory<M> {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            f.debug_tuple(stringify!(uniswap_v2_factory))
                .field(&self.address())
                .finish()
        }
    }
    impl<M: ::ethers::providers::Middleware> uniswap_v2_factory<M> {
    ...
    pub enum uniswap_v2_factoryCalls {
    ...
    impl ::ethers::core::abi::AbiDecode for uniswap_v2_factoryCalls {
        fn decode(
            data: impl AsRef<[u8]>,
    ...
    impl ::core::fmt::Display for uniswap_v2_factoryCalls {
        fn fmt(&self, f: &mut ::core::fmt::Formatter<'_>) -> ::core::fmt::Result {
            match self {
    ...
    impl ::core::convert::From<AllPairsCall> for uniswap_v2_factoryCalls {
        fn from(value: AllPairsCall) -> Self {
            Self::AllPairs(value)
        }
    }
    impl ::core::convert::From<AllPairsLengthCall> for uniswap_v2_factoryCalls {
        fn from(value: AllPairsLengthCall) -> Self {
            Self::AllPairsLength(value)
        }
    }
    impl ::core::convert::From<CreatePairCall> for uniswap_v2_factoryCalls {
        fn from(value: CreatePairCall) -> Self {
            Self::CreatePair(value)
        }
    }
    impl ::core::convert::From<FeeToCall> for uniswap_v2_factoryCalls {
        fn from(value: FeeToCall) -> Self {
            Self::FeeTo(value)
        }
    }
    impl ::core::convert::From<FeeToSetterCall> for uniswap_v2_factoryCalls {
        fn from(value: FeeToSetterCall) -> Self {
            Self::FeeToSetter(value)
        }
    }
    impl ::core::convert::From<GetPairCall> for uniswap_v2_factoryCalls {
        fn from(value: GetPairCall) -> Self {
            Self::GetPair(value)
        }
    }
    impl ::core::convert::From<SetFeeToCall> for uniswap_v2_factoryCalls {
        fn from(value: SetFeeToCall) -> Self {
            Self::SetFeeTo(value)
        }
    }
    impl ::core::convert::From<SetFeeToSetterCall> for uniswap_v2_factoryCalls {
