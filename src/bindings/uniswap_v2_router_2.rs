...
pub mod swap_router {
    ...
    impl ::core::convert::From<WethCall> for SwapRouterCalls {
        fn from(value: WethCall) -> Self {
            Self::Weth(value)
        }
    }
    impl ::core::convert::From<AddLiquidityCall> for SwapRouterCalls {
        fn from(value: AddLiquidityCall) -> Self {
            Self::AddLiquidity(value)
        }
    }
    impl ::core::convert::From<AddLiquidityETHCall> for SwapRouterCalls {
    ...
    impl ::core::convert::From<GetAmountInCall> for SwapRouterCalls {
        fn from(value: GetAmountInCall) -> Self {
            Self::GetAmountIn(value)
        }
    }
    impl ::core::convert::From<GetAmountOutCall> for SwapRouterCalls {
        fn from(value: GetAmountOutCall) -> Self {
            Self::GetAmountOut(value)
        }
    }
    impl ::core::convert::From<GetAmountsInCall> for SwapRouterCalls {
        fn from(value: GetAmountsInCall) -> Self {
            Self::GetAmountsIn(value)
        }
    }
    impl ::core::convert::From<GetAmountsOutCall> for SwapRouterCalls {
        fn from(value: GetAmountsOutCall) -> Self {
            Self::GetAmountsOut(value)
        }
    }
    impl ::core::convert::From<QuoteCall> for SwapRouterCalls {
        fn from(value: QuoteCall) -> Self {
            Self::Quote(value)
        }
    }
    impl ::core::convert::From<RemoveLiquidityCall> for SwapRouterCalls {
        fn from(value: RemoveLiquidityCall) -> Self {
            Self::RemoveLiquidity(value)
        }
    }
    impl ::core::convert::From<RemoveLiquidityETHCall> for SwapRouterCalls {
    ...
    impl ::core::convert::From<RemoveLiquidityETHWithPermitCall> for SwapRouterCalls {
    ...
    impl ::core::convert::From<RemoveLiquidityWithPermitCall> for SwapRouterCalls {
        fn from(value: RemoveLiquidityWithPermitCall) -> Self {
            Self::RemoveLiquidityWithPermit(value)
        }
    }
    impl ::core::convert::From<SwapETHForExactTokensCall> for SwapRouterCalls {
        fn from(value: SwapETHForExactTokensCall) -> Self {
            Self::SwapETHForExactTokens(value)
        }
    }
    impl ::core::convert::From<SwapExactETHForTokensCall> for SwapRouterCalls {
    ...
    impl ::core::convert::From<SwapExactTokensForETHCall> for SwapRouterCalls {
    ...
    impl ::core::convert::From<SwapTokensForExactETHCall> for SwapRouterCalls {
